...
" Initially created by  with ThemeCreator (https://github.com/mswift42/themecreator)
...
let s:bg3="#d6d6d6"
let s:bg4="#c2c2c2"
let s:keyword="#0033B3"
let s:builtin="#000000"
let s:const= "#871094"
let s:comment="#8C8C8C"
let s:func="#00627A"
let s:str="#067D17"
let s:type="#0033B3"
let s:var="#000000"
...
let s:light_gray="#eff0f1"
let s:dark_gray="#666666"
...
exe 'hi LineNr guifg='s:bg' guibg='s:bg
exe 'hi VertSplit guifg='s:light_gray' guibg='s:bg2
...
" Gui elements
exe 'hi TabLineFill guifg='s:light_gray' guibg='s:light_gray
exe 'hi TabLine guifg='s:dark_gray' guibg='s:light_gray
